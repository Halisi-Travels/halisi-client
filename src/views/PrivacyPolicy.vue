<template>
  <div class="privacy-policy-page">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Halisi Travels Agency, Cianda House, 11th
          Flr.
        </p>
      </li>
      <li>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Halisi Travels, accessible from
          <a
            href="https://halisitravels.com"
            rel="external nofollow noopener"
            target="_blank"
            >https://halisitravels.com</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>
        <p>By email: jobs@halisitravels.com</p>
      </li>
      <li>
        <p>
          By visiting this page on our website:
          <a
            href="https://www.halisitravels.com/contact"
            rel="external nofollow noopener"
            target="_blank"
            >https://www.halisitravels.com/contact</a
          >
        </p>
      </li>
    </ul>
